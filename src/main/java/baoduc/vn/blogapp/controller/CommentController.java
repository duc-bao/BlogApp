...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> createComment(
            @PathVariable(value = "postId") int postId, @Valid @RequestBody CommentDto commentDto) {
    ...
    public ResponseEntity<CommentDto> getCommentById(
            @PathVariable(value = "postId") int postId, @PathVariable(value = "commentId") int commentId) {
